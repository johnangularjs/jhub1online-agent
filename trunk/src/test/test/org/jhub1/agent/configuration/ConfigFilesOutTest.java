...
public class ConfigFilesOutTest {
	
	private static ConfigFilesOut config;
	...
	public static void setUpBeforeClass() {
		...
		config = new ConfigFilesOutImpl(prop);
	}
	
	@Test
	public void checkAccessToProperties() {
		assertEquals("file/output/", config.getPath());
		assertEquals(600, config.getPushFrequency());
